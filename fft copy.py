...
AppFont = 'Any 16'
sg.theme('Black')
CanvasSizeW = 1400 #modify this value to increase or decrease dimentions of the window (400-1200)
CanvasSizeH = 800 #modify this value to increase or decrease dimentions of the window (400-1200)


layout = [[sg.Graph(canvas_size=(CanvasSizeW, CanvasSizeH),
                    graph_bottom_left=(-8, -20),
